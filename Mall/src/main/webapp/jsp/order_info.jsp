...
<html>
	...
	<body>
								...
								<c:forEach items="${orders.list}" var="ordersItem">
									<tr class="active">
										<td width="60" width="40%">
											...
											<img src="${pageContext.request.contextPath}/${ordersItem.product.pimage}" width="70" height="60">
										</td>
										<td width="30%">
											<a target="_blank">${ordersItem.product.pname}</a>
										</td>
										<td width="20%">
											￥${ordersItem.product.shop_price}
										</td>
										<td width="10%">
											${ordersItem.count}
										</td>
										<td width="15%">
											<span class="subtotal">￥${ordersItem.subtotal}</span>
										</td>
									</tr>
								</c:forEach>
							</c:if>
			...
			<div>
				...
				<div style="margin-top:5px;margin-left:150px;">
					...
					<p style="text-align:right;margin-right:100px;">
						<a href="${pageContext.request.contextPath}/orderServlet?todo=pay">
		...
		<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
			Copyright &copy; 2018-2019 XXXX商城 版权所有
		</div>
